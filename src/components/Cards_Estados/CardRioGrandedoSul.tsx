...
import RS from '../../images/carrossel-estados/RS.png'

export default function CardRioGrandedoSul() {
  return (
    <div className="max-w-sm rounded-lg overflow-hidden shadow-sm relative">
      <div className="absolute left-0 p-3 mt-30">
        <h2 className="text-white text-2xl font-extrabold">Rio Grande do Sul</h2>
      </div>
      <img className="w-full rounded-xl" src={RS} alt="Rio Grande do Sul" />
